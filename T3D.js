...
function repaint3D() {
    for (var i = 0 ; i < snake.length ; i ++) {
        ...
        snake[i].snakeBody[0].style.zIndex = "999";
        snake[i].snakeBody[0].getElementsByClassName("circle")[0].getElementsByTagName("span")[0].style.transform = "rotateY(" + snake[i].nowToward.rotateY + "deg)";//控制囧字的朝向
    }
